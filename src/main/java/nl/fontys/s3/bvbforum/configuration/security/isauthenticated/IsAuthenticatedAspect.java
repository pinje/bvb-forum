package nl.fontys.s3.bvbforum.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(nl.fontys.s3.bvbforum.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(nl.fontys.s3.bvbforum.configuration.security.isauthenticated.IsAuthenticated)")
